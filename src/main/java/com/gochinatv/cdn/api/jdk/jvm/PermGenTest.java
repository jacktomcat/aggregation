...
public class PermGenTest {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        int[] s0 = new int[1024*256];
        //int[] s1 = new int[1024*256*2];
        //int[] s2 = new int[1024*256*2];
        //int[] s3 = new int[1024*256*2];
        //int[] s4 = new int[1024*256*2];
        //int[] s5 = new int[1024*256*2];
    }
